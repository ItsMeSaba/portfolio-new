  ...
  return (
    <>
      ...
      <motion.button
        layoutId={layout ? `card-${card.title}` : undefined}
        onClick={handleOpen}
        className="rounded-3xl bg-gray-100 dark:bg-neutral-900 aspect-square w-[300px] md:w-[375px] overflow-hidden flex flex-col items-start justify-start relative z-10"
      >
